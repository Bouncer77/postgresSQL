...
- [Какие навыки будут получены?](#new-skill)
- [Материалы курса](#_1)
	- [Скачать материалы курса](#_2)
	- [Скачать PostgeSQL](#download)
	- [Поддержка кириллицы](#_3)
	- [Утилита psql](#psql)
	- [Выполнение команд в среде XUbuntu](#xubuntu)
- [Quick Start](#quick-start)
		- [Пример использования на XUbuntu](#xubuntu_1)
	- [При ошибках в курсе](#_4)
	- [Расширения](#_5)
	- [Администрирование сервера](#_6)
		- [Утилиа для управления сервером - pg_ctl](#-pg_ctl)
		- [Журнал сервера](#_7)
	- [Конфигурационные файлы](#_8)
		- [Список конфигурационных файлов](#_9)
	- [Найстройка файла инициализации psql](#psql_1)
		- [Журнал сервера](#_10)
		- [Ссылки на доп информацию](#_11)
	- [Ключевые параметры](#key)

<!-- /MarkdownTOC -->

<a name="new-skill"><h2>Какие навыки будут получены?</h2></a>
...
<a name="key"><h2>Какие навыки будут получены?</h2></a>
